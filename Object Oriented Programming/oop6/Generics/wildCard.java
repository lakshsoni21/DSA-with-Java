...
//The Array list will of Number type float, integer, double but it can't be of Strings because
//We only want numbers using extends keyword
//Hamri Arraylist ka dataType Numbers Ke under hi lie karna chahiye that can be Integer,Float etc
